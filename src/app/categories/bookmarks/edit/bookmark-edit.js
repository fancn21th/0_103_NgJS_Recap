angular
  ...
  .config(function($stateProvider) {
    $stateProvider.state("recap.categories.bookmarks.edit", {
  ...
  .controller("EditBookmarkCtrl", function(
    ...
    BookmarksModel.getBookmarkById($stateParams.bookmarkId).then(function(
      bookmark
    ) {
      if (bookmark) {
        editBookmarkCtrl.bookmark = bookmark;
        editBookmarkCtrl.editedBookmark = angular.copy(
